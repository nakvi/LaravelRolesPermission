        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h2 >Permissions
                    <a href="{{url("permission/create")}}" class="btn btn-primary" style="float: right">Add Permission</a>
                </h2>
                </div>
                <div class="card-body">
                      <!--begin::Table wrapper-->
                        ...
                        <table id="DataTable"
                            ...
                            <tbody class="fw-6  text-gray-600">
                                ...
                                <tr @if ($loop->odd) class="bg-light  " @endif>
                                        <td class="border text-center" style="font-weight: bold;text-align:center">{{ $permission->id }}</td>
